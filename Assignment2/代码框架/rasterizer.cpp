...
void rst::rasterizer::MSAA(float x, float y, const Triangle& t, int& count, float& mindepth) {
  auto v = t.toVector4();
      ...
      for (int x = min_x; x <= max_x; x++) {
        for (int y = min_y; y <= max_y; y++) {
          ...
          if (insideTriangle(x + 0.25f, y + 0.25f, t.v)) {
            MSAA(x + 0.25f, y + 0.25f, t, count, mindepth);
          }
          if (insideTriangle(x + 0.75f, y + 0.25f, t.v)) {
            MSAA(x + 0.75f, y + 0.25f, t, count, mindepth);
          }
          if (insideTriangle(x + 0.75f, y + 0.75f, t.v)) {
            MSAA(x + 0.75f, y + 0.75f, t, count, mindepth);
          }
          if (insideTriangle(x + 0.25f, y + 0.75f, t.v)) {
            MSAA(x + 0.25f, y + 0.75f, t, count, mindepth);
          }
